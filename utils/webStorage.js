...
if (typeof window !== 'undefined') {
  ...
  // Also re-initialize when the page is shown (handles page refresh)
  window.addEventListener('pageshow', initializeCache);
}
  ...
  async setItem(key, value) {
    ...
    try {
      if (typeof window !== 'undefined' && window.localStorage) {
        ...
        console.log(`[WebStorage] ${key} ${value === null ? 'removed from' : 'saved to'} localStorage`);
      }
    } catch (error) {
